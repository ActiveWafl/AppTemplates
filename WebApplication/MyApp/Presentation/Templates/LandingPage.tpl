            ...
            <div class="Row">
                <div class="Spans9">
                    ...
                    <section class="Panel">
                        ...
                        <p>Application logic for web applications is usually handled in <a href="http://activewafl.com/Manual/AppProgramming/FunctionalModel">Functional Models</a> or in <mark>{APPLICATION_NAMESPACE}/Logic/[Pagename].php</mark> files.
                    </section>
                    <section class="Panel">
