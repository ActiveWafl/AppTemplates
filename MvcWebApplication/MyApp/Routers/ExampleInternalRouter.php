...
implements \DblEj\Communication\Http\Routing\IInternalRouter
{
    ...
    public function GetHttpRoute(\DblEj\Communication\Http\Request $request, \DblEj\Application\IWebApplication $app = null, \DblEj\Communication\Http\Routing\IRouter &$usedRouter = null)
    {
        ...
        //if we end up routing to a controller, pass-through the "Action"
        ...
        //then route the request to the "ExamplePage1" or "ExamplePage2" controller, respectively (in this example we pass-through the "Action").
        ...
        {
            $returnRoute = new Route($request, array(new \{APPLICATION_NAMESPACE}\Controllers\ExamplePage1(),"CallAction"), array($action, $request, $app));
        ...
        {
            $returnRoute = new Route($request, array(new \{APPLICATION_NAMESPACE}\Controllers\ExamplePage2(),"CallAction"), array($action, $request, $app));
