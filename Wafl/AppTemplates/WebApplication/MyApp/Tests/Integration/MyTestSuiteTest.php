...
//	$this->webDriver->get(\Wafl\Core::$RUNNING_APPLICATION->Get_Settings()->Get_Web()->Get_WebUrl());
//
//	// adding cookie
...
//	$this->webDriver->get(\Wafl\Core::$RUNNING_APPLICATION->Get_Settings()->Get_Web()->Get_WebUrl());
//	self::assertEquals(
//		'ActiveWAFL Blog', $this->webDriver->findElement(WebDriverBy::linkText('What Next'))->getText()
//	);
//    }
